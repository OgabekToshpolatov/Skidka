        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitudes = table.Column<long>(type: "bigint", nullable: false),
                    Longitudes = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVoters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVoters_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductCategoryApproachId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVoters_ProductId",
                table: "ProductVoters",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVoters_UserId1",
                table: "ProductVoters",
                column: "UserId1");
